...
ALTER TABLE projects
  ...
  ALTER COLUMN is_complete_mission TYPE BOOLEAN USING NULLIF(is_complete_mission, '')::boolean,
  ALTER COLUMN is_complete_mission SET DEFAULT false,
  ALTER COLUMN is_chantier TYPE BOOLEAN USING NULLIF(is_chantier, '')::boolean,
